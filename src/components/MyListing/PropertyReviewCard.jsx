                  ...
                  <View style={styles.taskBox}>
                    {approvalTasks.map((task, index) => (
                      <View key={index} style={styles.taskRow}>
                        <Text style={[styles.bullet, {color: '#60c969'}]}>
                          •
                        </Text>
        ...
        <View style={styles.deleteModalBackground}>
          <View style={styles.deleteModalCard}>
            ...
            <View style={styles.deletePropertyInfo}>
              <Text style={styles.deletePropertyName}>
                {property?.propertyName}
              </Text>
              <Text style={styles.deletePropertyId}>
                ID: REP${property?.propertyid}
              </Text>
            </View>
...
const styles = StyleSheet.create({
  modalBackground: {
    flex: 1,
    backgroundColor: 'rgba(97, 93, 93, 0.5)',
